...
public abstract interface EnchereDAO {
	...
	List<Enchere> afficherEncheresEnCours(Utilisateur utilisateur, int categorie, String article)
			throws BusinessException;

	List<Enchere> afficherEncheresRemportees(Utilisateur utilisateur, int categorie, String article)
			throws BusinessException;
