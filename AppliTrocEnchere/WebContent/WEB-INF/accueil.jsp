			...
			<form action="<%=request.getContextPath()%>/Accueil" method="post">
				<div class="filtres">
					...
					<input class="formulaire-items" type="text" id="textfield"
						name="filtre_nom_article"
						placeholder="Le nom de l'article contient" size="60"
						style="height: 30px">
					...
					<div class=choix>
						<div class="achatVente">
							...
							<div class="formulaire-checkbox">
								<input type="checkbox" id="encheresRemportees" name="Achat"
									...
									class="formulaire-items" for="encheresRemportees">mes
						...
						<script>
							$('input[name="AchatVente"]').on(
									'change',
									function() {
										$('input[name="Achat"]').attr(
												'disabled',
												this.value != "Achats")
										$('input[name="Achat"]').attr(
												'enabled',
												this.value == "Achats")
										$('input[name="Ventes"]').attr(
												'disabled',
												this.value == "Achats")
										$('input[name="Ventes"]').attr(
												'enabled',
